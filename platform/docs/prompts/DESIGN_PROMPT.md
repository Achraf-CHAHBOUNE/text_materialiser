# Frontend Design Prompt — "Anonymize" (works in BOTH Claude & Lovable)

Paste this same prompt into **Claude** (it will produce an interactive design mockup
you can click through) and into **Lovable** (it will build the real app), then compare
the two designs. It is written to be tool-neutral and UI-focused, with realistic mock
data so the screens look real without any backend.

---

Build a **polished, fully interactive frontend prototype** for a legal-tech SaaS called
